...
urlpatterns = [
    ...
    path('spam_detail/<int:pk>/', SpamDetailView.as_view(template_name='authorization/content.html'), name='spam_detail'),
    path('create/', SpamCreateView.as_view(template_name='authorization/create_spam.html'), name='create_spam'),
    path('spam/<int:pk>/delete/', SpamDeleteView.as_view(template_name='authorization/confirm_delete.html'), name='delete_spam'),
